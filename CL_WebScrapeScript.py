# This script is very rough attempt at scraping Craigslist data in the Charlotte area
# It successfully scrapes the first two or three pages (300-400 vehicles' data), but crashes
# This was enough for the purposes of my project and may return to update later.
...
url = "https://charlotte.craigslist.org/search/cta?auto_bodytype=1&auto_bodytype=10&auto_bodytype=11&auto_bodytype=12&auto_bodytype=2&auto_bodytype=3&auto_bodytype=4&auto_bodytype=5&auto_bodytype=6&auto_bodytype=7&auto_bodytype=8&auto_bodytype=9&auto_cylinders=1&auto_cylinders=2&auto_cylinders=3&auto_cylinders=4&auto_cylinders=5&auto_cylinders=6&auto_cylinders=7&auto_cylinders=8&auto_fuel_type=1&auto_fuel_type=2&auto_fuel_type=3&auto_fuel_type=4&auto_fuel_type=6&auto_paint=1&auto_paint=10&auto_paint=11&auto_paint=2&auto_paint=20&auto_paint=3&auto_paint=4&auto_paint=5&auto_paint=6&auto_paint=7&auto_paint=8&auto_paint=9&auto_size=1&auto_size=2&auto_size=3&auto_size=4&auto_title_status=1&auto_title_status=2&auto_title_status=3&auto_title_status=4&auto_title_status=5&auto_title_status=6&auto_transmission=1&auto_transmission=2&auto_transmission=3&bundleDuplicates=1&condition=10&condition=20&condition=30&condition=40&condition=50&condition=60&hasPic=1&max_auto_miles=500000&max_auto_year=2020&max_price=100000&min_auto_miles=1&min_auto_year=1900&min_price=500"
response = requests.get(url)
html = response.text
...
file = open('CraigslistCarData.csv', 'w')
...
for a in table.find_all('a', href = True):
    ...
    if((inc%2) == 0):
        ...
        if (x != "#"):
            ...
            try:
                postPrice = int((postTitle.find(class_ = "price").get_text()).replace('$','').strip())
